                ...
                <Space size="middle">
                    {
                        ...
                        text === "isAdmin" ?
                            <Tag color="blue" key={text} style={{ width: 120, textAlign: "center" }} icon={<CopyOutlined />}>
                                Quản lý
                            </Tag> : text === "isSeller" ? <Tag color="green" key={text} style={{ width: 120, textAlign: "center" }} icon={<CheckCircleOutlined />}>
                                Nhà bán hàng
                            </Tag> : <Tag color="magenta" key={text} style={{ width: 120, textAlign: "center" }} icon={<CheckCircleOutlined />}>
                                Khách hàng
                            </Tag>
                    }
