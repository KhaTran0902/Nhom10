                    ...
                    <Card id="dialog" bordered={false} >
                        ...
                        >
                            <Form.Item style={{ marginBottom: 3 }}>
                                ...
                                <Divider style={{ marginBottom: 5, fontSize: 19 }} orientation="center">HỆ THỐNG BÁN MÁY TÍNH VÀ THIẾT BỊ MÁY TÍNH</Divider>
                            </Form.Item>
                            <Form.Item style={{ marginBottom: 16 }}>
                                <p className="text">Đăng ký tài khoản nhà bán hàng</p>
                            </Form.Item>
