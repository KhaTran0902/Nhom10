...
router.get("/search/user/:userId", productController.searchProductsCreatedByUser);

router.post("/searchByPrice", productController.getSearchPrice);
router.get('/user/products/:userId/', verifyToken.checkLogin, productController.getProductsByUser);
